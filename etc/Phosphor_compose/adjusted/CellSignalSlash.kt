// Package for the Phosphor icon set
...
// Phosphor object with CellSignalSlash ImageVector property
object Phosphor {

    // CellSignalSlash ImageVector implementation
    val CellSignalSlash: ImageVector
        get() {
            ...
            _cell_signal_slash = Builder(
                ...
                // Define the path for the image vector
                path(
                    fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero
                ) {
                    // Path data for the image vector
                    moveTo(129.8f, 94.2f)
